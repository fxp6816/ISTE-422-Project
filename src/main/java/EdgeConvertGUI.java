...
public class EdgeConvertGUI {
   ...
   //logger
   //static final Logger logger = LogManager.getLogger(EdgeConvertGUI.class.getName());
   ...
   public EdgeConvertGUI() {
      //logger.info("Entering EdgeConvertGUI");
   ...
   public void createDTScreen() {//create Define Tables screen
      ...
      //logger.debug("Creating the Define Tables Screen...");
                  ...
                  switch (i) {
                     ...
                     case 2: //Integer
                        try {
                           ...
                           //logger.error("Number format error" + nfe.toString());
      ...
      //logger.debug("Define Tables Screen Created...");
   ...
   public void createDRScreen() {
      ...
      jfDR.getContentPane().add(jpDRBottom, BorderLayout.SOUTH);
         ...
         //logger.debug("Define Relations Screen Created");
   ...
   private void writeSave() {
      if (saveFile != null) {
         try {
            ...
            //logger.error("IO Exception: " + ioe.toString());
            //logger.debug("Saved Failed...");
   ...
   private void getOutputClasses() {
      ...
      try {
         ...
         //logger.error("Instantiation Exception: "+ ie.toString());
         ie.printStackTrace();
      } catch (ClassNotFoundException cnfe) {
         //logger.error("Class Not Found Exception: " + cnfe.toString());
         cnfe.printStackTrace();
      } catch (IllegalAccessException iae) {
         //logger.error("Illegal Access Exception: " + iae.toString());
         iae.printStackTrace();
      } catch (NoSuchMethodException nsme) {
         //logger.error("No Such Method Exception: " + nsme.toString());
         nsme.printStackTrace();
      } catch (InvocationTargetException ite) {
         //logger.error("Invocation Target Exception: " + ite.toString());
         ite.printStackTrace();
      } catch (Exception e ) {
         //logger.error("Exception: " + e.toString());
      }
   ...
   private void writeSQL(String output) {
     ...
     //logger.debug("Attempting to write the SQL statement (writeSQL())...");
      ...
      if (returnVal == JFileChooser.APPROVE_OPTION) {
         ...
         try {
            ...
            //close the file
            pw.close();
            //logger.debug("Successfull SQL output (writeSQL())...");
         } catch (IOException ioe) {
           // logger.error("IO exception: " + ioe.toString());
            System.out.println(ioe);
         }
